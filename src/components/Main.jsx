            ...
            <>
                <main className='main grow flex flex-col gap-y-8'>
                    ...
                    <div className='flex justify-center'>
                        <Button to="/generate" icon={<FontAwesomeIcon icon="fa-solid fa-plus" />} className="text-[--text-secondary] px-4 py-2 bg-(--secondary-color) rounded-xs flex justify-center items-center gap-x-2" >New Reviewer</Button>
    ...
    return (
        <>
            <main className="main grow flex flex-col justify-center items-center">
                ...
                <Button to="/generate" icon={<FontAwesomeIcon icon="fa-solid fa-plus" />} className="text-[--text-secondary] px-4 py-2 mt-16 bg-(--secondary-color) rounded-xs flex justify-center items-center gap-x-2" >New Reviewer</Button>
